...
title: About
description: >
  2018年４月〜2021年6月　SIエンジニア  
  2021年７月〜　　　　　 自社サービスエンジニア  

  Native Level : Korean  
  Business Level : Japanese   
  Studying Level : English   
    
  Server Language(framework, library等) : Java, PHP, C#.NET, Laravel, vb.NET, spring bootが実装できるレベル。  
  Database Language : postgreSQL, Mysql, MSSQL, Oracleが実装できるレベル。  
  Client Language(framework, library等) : Jquery, Javascript, HTML, Cssが実装できるレベル、vuejsが学習中。   
